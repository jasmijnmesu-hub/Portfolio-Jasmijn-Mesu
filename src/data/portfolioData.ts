...
export const initialEvidenceItems: EvidenceItem[] = [
  {
    ...
    summary: 'Ik ontwerp en bouw dit digitale portfolio om mijn onderzoek, prototypes en reflecties overzichtelijk bij te houden en te onderbouwen.',
    type: 'prototype',
  ...
  },
  {
    ...
    summary: 'Ook ontwikkel ik een AI-kennisassistent voor NEN- en ISO-normen in de bouw, waarbij ik onderzoek hoe AI veranderende regelgeving toegankelijk kan maken.',
    type: 'prototype',
    platform: 'Applicatie',
    externalUrl: '#',
    sprintId: 1,
